  ...
  return (
    <div className="py-12 bg-white flex-1">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        {/* Banner & Intro */}
        <div className="bg-[#0A3642] text-white rounded-2xl p-8 sm:p-12 border border-teal-800 space-y-6 shadow-lg">
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-2xl p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm text-slate-700">
            <div className="bg-white p-5 rounded-xl border border-slate-200 space-y-2 shadow-sm">
              <h3 className="font-bold text-[#0F4C5C] text-base">1. Internal Dimensions</h3>
            ...
            <div className="bg-white p-5 rounded-xl border border-slate-200 space-y-2 shadow-sm">
              <h3 className="font-bold text-[#0F4C5C] text-base">2. Select the Right Ply</h3>
              <p className="leading-relaxed">
            ...
            <div className="bg-white p-5 rounded-xl border border-slate-200 space-y-2 shadow-sm">
              <h3 className="font-bold text-[#0F4C5C] text-base">3. Request Final Quote</h3>
              <p className="leading-relaxed">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-8 space-y-6 shadow-sm">
          ...
          <div className="pt-2">
            <ul className="grid grid-cols-2 sm:grid-cols-3 gap-3 text-sm font-semibold text-[#0F4C5C]">
        ...
        <div className="max-w-4xl mx-auto space-y-8 pt-4">
          ...
          <div className="space-y-4 text-left">
            <div className="bg-slate-50 border border-slate-200 rounded-lg p-5 sm:p-6 shadow-sm">
              <h3 className="font-bold text-[#0F4C5C] text-base mb-2">
