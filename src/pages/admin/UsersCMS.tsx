...
export function UsersCMS() {
  ...
  return (
    <div className="space-y-6">
      {/* Header Banner */}
      <div className="bg-gradient-to-r from-[#0F4C5C] to-[#164e63] rounded-2xl p-6 sm:p-8 text-white shadow-xl relative overflow-hidden">
          ...
          <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="relative w-full sm:w-80">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 text-sm bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0F4C5C]/20 focus:border-[#0F4C5C]"
              />
            </div>
            ...
            <div className="flex items-center gap-3 w-full sm:w-auto">
              ...
              <select
                ...
                className="px-3 py-2 text-sm bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0F4C5C]/20 focus:border-[#0F4C5C]"
              >
            ...
            <form onSubmit={handleSaveUser} className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full pl-3.5 pr-10 py-2 text-sm bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0F4C5C]/20 focus:border-[#0F4C5C] font-mono"
                  />
                  <button
                    type="button"
                ...
                <div className="flex flex-col justify-end">
                  <label className="flex items-center gap-2 text-xs font-bold text-slate-700 cursor-pointer p-2 bg-slate-50 rounded-lg border border-slate-200">
                    <input
                      ...
                      className="rounded text-[#0F4C5C] focus:ring-[#0F4C5C]"
                    />
              ...
              <div className="pt-4 border-t border-slate-200 flex items-center justify-end gap-3">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2 bg-[#0F4C5C] hover:bg-[#0c3c49] text-white text-sm font-bold rounded-lg transition-colors shadow-sm disabled:opacity-50"
                >
                  {isSubmitting ? (
                    <>
            ...
            <form onSubmit={handleSaveResetPassword} className="p-6 space-y-4">
              ...
              <div className="pt-3 border-t border-slate-200 flex items-center justify-end gap-3">
                ...
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="px-5 py-2 bg-[#0F4C5C] hover:bg-[#0c3c49] text-white text-sm font-bold rounded-lg transition-colors disabled:opacity-50"
                >
