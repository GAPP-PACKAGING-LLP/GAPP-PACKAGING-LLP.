    ...
    <div className="py-12 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        {activeTab === 'machinery' ? (
          <div className="space-y-12">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-8 flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <button
                onClick={() => setActiveTab('tour')}
                className="bg-brand-primary hover:bg-brand-primary-hover text-white px-6 py-3 rounded-xl font-bold text-xs uppercase tracking-wider transition-colors shrink-0 flex items-center gap-2 cursor-pointer"
              >
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-2xl p-8 space-y-4 flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <Link
            to="/quality"
            className="inline-flex items-center gap-2 font-bold text-xs uppercase tracking-wider bg-brand-primary text-white px-6 py-3 rounded-lg hover:bg-brand-primary-hover transition-colors shrink-0"
          >
