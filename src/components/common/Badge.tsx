...
export const Badge: React.FC<BadgeProps> = ({ 
  ...
  const variantStyles = {
    teal: 'bg-brand-primary/10 text-brand-primary border border-brand-primary/20',
    blue: 'bg-[#008CE8]/10 text-[#008CE8] border border-[#008CE8]/20 font-bold',
    amber: 'bg-brand-accent/10 text-brand-accent-hover border border-brand-accent/20',
