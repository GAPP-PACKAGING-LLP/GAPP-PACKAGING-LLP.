      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-6">
          <div className="inline-flex items-center gap-2 bg-white px-3.5 py-1.5 rounded-full border border-slate-200 shadow-xs text-xs font-semibold text-slate-800">
            ...
            <span className="text-[#0F4C5C]">Mandideep Plant Active</span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 pt-1 text-sm text-[#334155]">
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-[#0F4C5C] shrink-0" />
            ...
            <div className="pt-3 flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5">
              <button
                ...
                className="inline-flex items-center justify-center gap-2.5 bg-[#0F4C5C] hover:bg-[#0A3642] text-white px-7 py-3.5 rounded-md font-bold text-sm shadow-md transition-all duration-150 active:scale-95 cursor-pointer"
              >
              ...
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 bg-white hover:bg-slate-50 text-[#0F4C5C] border border-slate-300 px-6 py-3.5 rounded-md font-semibold text-sm shadow-xs transition-colors"
              >
                <Factory className="w-4 h-4 text-[#D97706]" />
            ...
            <div className="pt-2 flex flex-wrap items-center gap-4 text-xs text-[#475569]">
              <span className="flex items-center gap-1.5 font-medium">
                ...
                <a href="tel:+919806419199" className="text-[#0F4C5C] font-bold hover:underline">
                  +91 9806419199
                </a>
              </span>
              ...
              <span className="flex items-center gap-1.5 font-medium">
                ...
                <a href="tel:+919981280902" className="text-[#0F4C5C] font-bold hover:underline">
                  +91 9981280902
                </a>
              </span>
              <span className="text-slate-300">|</span>
              <button
                ...
                className="text-[#0F4C5C] hover:text-[#0A3642] font-semibold underline underline-offset-2 cursor-pointer"
              >
          ...
          <div className="lg:col-span-5">
            <div className="bg-white rounded-xl shadow-lg border border-slate-200/80 p-6 space-y-5 relative overflow-hidden">
              ...
              <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 rounded-full bg-[#0F4C5C]"></div>
              ...
              <div className="bg-[#0F4C5C]/5 p-4 rounded-lg border border-[#0F4C5C]/15 space-y-2">
              ...
              <div className="space-y-2 font-mono text-xs">
                <div className="bg-slate-50 p-2.5 rounded border border-slate-200 flex justify-between items-center">
                  ...
                  <span className="text-[11px] font-bold text-[#0F4C5C]">High-speed fingerless corrugation</span>
                </div>
                <div className="bg-slate-50 p-2.5 rounded border border-slate-200 flex justify-between items-center">
                  <span className="font-semibold text-slate-800 font-sans">Printing:</span>
                  <span className="text-[11px] font-bold text-[#0F4C5C]">Two colour flexo printing inline</span>
                </div>
                <div className="bg-slate-50 p-2.5 rounded border border-slate-200 flex justify-between items-center">
                  <span className="font-semibold text-slate-800 font-sans">Joint Finishing:</span>
                  <span className="text-[11px] font-bold text-[#0F4C5C]">Semi automatic flap pasting & stitching</span>
                </div>
                <div className="bg-slate-50 p-2.5 rounded border border-slate-200 flex justify-between items-center">
                  <span className="font-semibold text-slate-800 font-sans">In-house Lab:</span>
                  <span className="text-[11px] font-bold text-[#0F4C5C]">5 Dedicated testing instruments</span>
                </div>
              </div>
              ...
              <div className="pt-1">
                <a
                  href="#box-calculator"
                  className="w-full flex items-center justify-between bg-[#0F4C5C]/10 hover:bg-[#0F4C5C]/15 text-[#0F4C5C] px-3.5 py-2.5 rounded-md text-xs font-bold transition-colors"
                >
        ...
        <div className="mt-12 sm:mt-16 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 pt-8 border-t border-slate-200">
          {companyData.stats.map((stat, idx) => (
            <div key={idx} className="bg-white p-4 sm:p-5 rounded-lg border border-slate-200 shadow-xs">
              <div className="text-xl sm:text-2xl font-extrabold text-[#0F4C5C] font-mono">
                {stat.value}
              </div>
